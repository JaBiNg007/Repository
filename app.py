...
import matplotlib.font_manager as fm  # เพิ่ม: สำห	รับจัดการฟอนต์ใน Matplotlib

# ตั้งค่าฟอนต์สำหรับ Matplotlib (ตัวอย่าง)
# เพื่อลด Warning และพยายามใช้ฟอนต์ที่ Render มี (ระบบ Linux)กิจกรรมเป็นภาษาอังกฤษ
plt.rcParams['font.family'] = ['DejaVu Sans', 'sans-serif'] 
# หากต้องการแสดงผลภาษาไทยอย่างถูกต้อง ควรติดตั้งฟอนต์ที่ Render Server มี หรือใช้ชื่อ
...
def index():
    if request.method == 'POST':  # ถ้าเป็นการส่งข้อมูลจากฟอร์ม (Submit)
        ...
        # เปลี่ยนข้อความ error ให้เป็นมิตรขึ้น ไม่แสดงรายละเอียดทางเทคนิคของ 'e'
        return render_template('index.html', error="เกิดข้อผิดพลาดในการประมวลผล กรุณาลองใหม่อีกครั้ง หรือตรวจสอบข้อมูลที่ป้อนว่าถูกต้องหรือไม่")
